...
<nav class="navbar navbar-expand-lg navbar-dark default-color sticky-top">
  <a class="navbar-brand" rel="next" href="<?php echo PATH; ?>/teacher/home.php">Teachers Toolkit</a>
...
<script>
  ...
  axios.get('http://localhost/teachers-toolkit-app/server/teacher/findOne/<?php echo $_SESSION['account_id'];?>')
    .then(data => {
      data = data.data;
      if (data.result === 1) {
