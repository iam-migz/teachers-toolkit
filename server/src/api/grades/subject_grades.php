<?php
    ...
    $response = file_get_contents('http://localhost/teachers-toolkit-app/server/api/classrecord/read_by_subject_assignment.php?subject_assignment_id='.$_GET['subject_assignment_id']);
    ...
    foreach($subject_data as $cr) {
        ...
        array_push($subject_grades, $cr);
    }

    echo json_encode($subject_grades);
